...
Route::post('/inquiry-store', [RequestController::class, 'storeContact'])->name('inquiry.store');
Route::post('/quote-store', [RequestController::class, 'storeQuote'])->name('quote.store');



Route::get('/package-track', function () {
