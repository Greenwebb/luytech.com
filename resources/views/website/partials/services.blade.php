            ...
            <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="service-item">
                    ...
                    <div class="service__content">
                        ...
                        <a href="{{ route('service.detail', 1)}}" class="btn btn__white">
            ...
            <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="service-item">
                    ...
                    <div class="service__content">
                        ...
                        <a href="{{ route('service.detail', 2)}}" class="btn btn__white">
                            <span>Read More</span><i class="icon-arrow-right"></i>
                        </a>
                    </div>
                </div><!-- /.service-item -->
            ...
            <div class="col-sm-6 col-md-6 col-lg-4">
                <div class="service-item">
                    ...
                    <div class="service__content">
                        ...
                        <a href="{{ route('service.detail', 3)}}" class="btn btn__white">
                            <span>Read More</span><i class="icon-arrow-right"></i>
                        </a>
                    </div>
                </div><!-- /.service-item -->
