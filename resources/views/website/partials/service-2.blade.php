    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <h1 class="pagetitle__heading">Clearing & Forwarding</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('index') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('services') }}">Services</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Clearing & Forwarding</li>
                    </ol>
                </nav>
            </div><!-- /.col-lg-12 -->
        </div><!-- /.row -->
        ...
        <aside class="sidebar mb-30">
            <div class="widget widget-categories">
                ...
                <div class="widget-content">
                    ...
                    <li><a href="{{ route('service.detail', 2)}}" class="active">Clearing & Forwarding </a></li>
