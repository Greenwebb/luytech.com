    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <h1 class="pagetitle__heading">Import & Delivery Of Vehicles</h1>
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{ route('index') }}">Home</a></li>
                        <li class="breadcrumb-item"><a href="{{ route('services') }}">Services</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Import & Delivery Of Vehicles</li>
                    </ol>
                </nav>
            </div><!-- /.col-lg-12 -->
        </div><!-- /.row -->
          ...
          <div class="widget widget-categories">
            ...
            <div class="widget-content">
              <ul class="list-unstyled">
                <li><a href="{{ route('service.detail', 1)}}" class="active">Import & Delivery Of Vehicles</a></li>
                <li><a href="{{ route('service.detail', 2)}}">Clearing & Forwarding </a></li>
                <li><a href="{{ route('service.detail', 3)}}">Vehicle Registration & Insurance</a></li>
              </ul>
            </div>
          </div>
