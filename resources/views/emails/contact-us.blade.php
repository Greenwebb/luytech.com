...
<html lang="en" 
  ...
  <body style="margin:4; padding:0; background:#F78403;">
    ...
    <div style="width:100%; max-width:600px; background:#ffffff; padding:30px 20px; text-align:left; font-family: 'Arial', sans-serif;">
      ...
      <a href="https://luytechzm.com">
        <img src="https://luytechzm.com/public/web/assets/images/logo/logo-dark.png" width="100" style="display:block; margin-bottom:30px;">
      </a>
      
      <h1 style="font-size:16px; line-height:22px; font-weight:normal; color:#333333;">
        Hello LuytechZM Team!
      </h1>
            ...
            <table border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td bgcolor="#556270" 
                    ...
                    align="center">
                    <a href="https://luytechzm.com/contact-inquiries" 
                       target="_blank" 
      ...
      <p style="font-size:12px; line-height:18px; color:#999999; margin-bottom:10px;">
        ...
        <a href="https://luytechzm.com" 
           ...
           Luytech Invesment Limited</a>, All Rights Reserved.
      </p>
