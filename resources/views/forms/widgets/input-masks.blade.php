...
@push('plugin-styles')
    {!! Html::style('public/web/assets/css/forms/form-widgets.css') !!}
@endpush
...
@push('plugin-scripts')
    {!! Html::script('public/web/plugins/input-mask/jquery.inputmask.min.js') !!}
    {!! Html::script('public/web/assets/js/forms/input-mask.js') !!}
@endpush
